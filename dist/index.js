...
import { callbackHandler, mobileCallbackHandler, } from "./controllers/userControllers.js";
...
export const mobileOAuth2Client = new google.auth.OAuth2(process.env.CLIENT_ID, process.env.CLIENT_SECRET, `${SERVER_URL}/auth/mobile-callback`);
app.use(cors({
    origin: true,
    credentials: true,
}));
